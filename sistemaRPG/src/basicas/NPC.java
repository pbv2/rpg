...
public class NPC extends Personagem{
	...
	public NPC(int id, String nome, int forca, int habilidade, int resistencia, int armadura, int poderdefogo, int pontodevida,
			int pontodemana, Classe classe, Raca raca,
			Vantagens vantagens,
